    ...
    return (
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-50 w-96 bg-gray-900 border border-gray-700 rounded-xl shadow-2xl flex flex-col overflow-hidden backdrop-blur-md bg-opacity-95 ring-1 ring-white/10 animate-in fade-in zoom-in duration-200">
            ...
            <div className="p-5 space-y-4">
                ...
                <div className="flex items-center justify-between text-xs text-gray-400 bg-black/40 p-3 rounded-lg border border-white/5">
                    <span className="truncate max-w-[40%] font-mono text-blue-300" title={edge.source}>{edge.source}</span>
                    <ArrowRight className="w-3 h-3 text-gray-600" />
                    <span className="truncate max-w-[40%] font-mono text-green-300" title={edge.target}>{edge.target}</span>
                </div>
