  ...
  useEffect(() => {
    if (documentNode && !isEditing) {
      setEditForm({
        ...
        style: documentNode.style || 'default', // Replaces node_type
        parent_id: documentNode.parent_id || '', // Replaces Topic/Module hierarchy
        ...
        <div className="space-y-4 sm:space-y-6 w-full">
          <div className="bg-[#1C1C1E] p-3 sm:p-4 rounded-xl border border-white/10">
            ...
            <div className="space-y-4">
              ...
              {/* Legacy Topic/Module Section Removed */}
        ...
        <div className="flex items-center gap-1 shrink-0">
          ...
          {onSwitchChatMode && (
            <button
              ...
              className={`p-2 rounded-lg transition-colors ${chatMode === 'multi-node'
